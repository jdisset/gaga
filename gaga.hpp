...
// MPI specifics
    ...
    protected:
        ...
        void printStart()
        {
            ...
            std::cout << std::endl;
            std::cout << YELLOW << "              ☀     " << NORMAL << " Starting GAGA " << YELLOW << "    ☀ " << NORMAL;
            std::cout << std::endl;
            ...
            std::cout << "  ▹ nb of tournament competitors = " << BLUE << tournamentSize << NORMAL << std::endl;
            std::cout << "  ▹ selection = " << BLUE << selectMethodToString(selecMethod) << NORMAL << std::endl;
...
#endif
#ifdef OMP
            std::cout << "  ▹ OpenMP parallelisation is " << GREEN << "enabled" << NORMAL << std::endl;
#else
            std::cout << "  ▹ OpenMP parallelisation is " << RED << "disabled" << NORMAL << std::endl;
#endif
            std::cout << GREY;
            for (int i = 0; i < nbCol - 1; ++i) std::cout << "━";
        ...
        void printGenStats(size_t n)
        {
            ...
            for (const auto& o : genStats[n])
            {
                if (o.first != "global")
                {
                    ...
                    std::cout << tableText(l, output.str(), "    " GREYBOLD GREENBOLD GREYBOLD NORMAL YELLOWBOLD NORMAL YELLOW NORMAL GREENBOLD NORMAL);
                }
            }
